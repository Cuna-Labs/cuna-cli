...
test("browser handoff source contains no prohibited Windows execution intermediary", async () => {
...
test("endpoint-security policy detects representative historical execution patterns", () => {
